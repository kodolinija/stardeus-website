...
image: /img/codex/sprites/database/objects/cosmetics/skull02.png
section: "Database"
---

<p>A realistic replica of a human skull used for spooky decor.</p>
<h3 class="codex-subtitle">Construction Cost</h3>
<p><span style="font-size:75%">→</span> <span class="nobr"><a href="/codex/database/obj/materials/gold-ingot/">Gold Ingot</a></span> x1</p>
...
<figure class="codex-image"><img src="/img/codex/sprites/database/objects/cosmetics/skull02.png" alt="Decorative Skull preview" loading="lazy"></figure>
