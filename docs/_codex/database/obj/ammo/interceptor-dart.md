...
<p>A compact, self-guided missile designed for short-range defense, capable of intercepting moving targets with precision.</p>
<h3 class="codex-subtitle">Craftable</h3>
<p>Produced in <span class="nobr"><a href="/codex/database/objects/devices/crafting-station/">Crafting Station</a></span><br> <span style="font-size:75%">→</span> <span class="nobr"><a href="/codex/database/obj/materials/transistor/">Transistor</a></span> x5 + <span class="nobr"><a href="/codex/database/obj/materials/battery-cell/">Battery Cell</a></span> + <span class="nobr"><a href="/codex/database/obj/materials/titanium-plate/">Titanium Plate</a></span> + <span style="color:#A0BBF7">20kW x 4h</span> = <span class="nobr"><span class="accent">Interceptor Darts</span></span></p>
